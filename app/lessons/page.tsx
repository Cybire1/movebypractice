    ...
    <div className="min-h-screen bg-surface-secondary text-foreground pb-32">
      ...
      <div className="sticky top-24 z-20 px-6 mb-12">
        <div className="max-w-7xl mx-auto flex justify-center">
          <div className="inline-flex bg-[var(--surface-overlay)] backdrop-blur-md p-1.5 rounded-2xl border border-[var(--border-default)] shadow-lg shadow-zinc-200/50 overflow-x-auto max-w-full scrollbar-hide">
